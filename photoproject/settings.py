...
INSTALLED_APPS = [
    ...
    'accounts.apps.AccountsConfig', # ユーザ認証用で追加
]
...
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend' # メール送信の設定

# ログインを必須にするための仕組み
LOGIN_URL = 'accounts:login' # ログインページのURL
LOGIN_REDIRECT_URL = 'photo:index' # ログイン後のリダイレクト先
